define([], function () {
  'use strict';
  // var baseURLFrontend = 'http://172.16.111.102',
  // var baseURLFrontend = 'http://localhost',
  var baseURLFrontend = 'http://172.16.111.150',
    portFrontend = '4444',

    baseURLPhp = 'http://172.16.111.150',
    portPhp = '5555',
    // baseURLPhp = 'http://192.168.12.3',
    // portPhp = '5555',

    baseURLWeb = 'http://192.168.12.3',
    portWeb = '8080',

    baseURLJava = 'http://192.168.12.3',
    portJava = '8080',

    baseURLEval = 'http://localhost',
    portEval = '8080';
