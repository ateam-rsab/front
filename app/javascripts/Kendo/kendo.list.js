    ...
    (function($, undefined) {
        ...
        var List = kendo.ui.DataBoundWidget.extend({
            ...
            _adjustListWidth: function() {
                ...
                if (this.element.data('width-actual')) {
                    computedWidth = this.element.data('width-actual');
                }
        ...
        ui.Select = List.extend({
            ...
            _options: function(data, optionLabel, value) {
                var that = this,
                    ...
                    length = data.length,
                    options = '',
                    option, dataItem, dataText, dataValue, idx = 0;
                if (optionLabel) {
                    options = optionLabel;
                }
                for (; idx < length; idx++) {
        ...
        var StaticList = kendo.ui.DataBoundWidget.extend({
            ...
            select: function(indices) {
                ...
                if (indices.length) {
                    ...
                    that.added = that._select(indices);
                }
                if (that.added.length || removed.length) {
            ...
            _template: function() {
                ...
                if (!template) {
                    template = kendo.template('<li tabindex="-1" role="option" unselectable="on" class="k-item">${' + kendo.expr(options.dataTextField, 'data') + '}</li>', {
                        useWithBlock: false
                    });
                } else {
