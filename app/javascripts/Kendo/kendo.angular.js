...
(function(f, define) {
    ...
    (function($, angular, undefined) {
        ...
        var module = angular.module('kendo.directives', []),
            ...
            $defaultCompile, $log = $injector.get('$log');
        ...
        function setupRebind(widget, scope, element, originalElement, rebindAttr, destroyRegister, attrs) {
            var unregister = scope.$watch(rebindAttr, function(newValue, oldValue) {
                if (widget && !widget._muteRebind && newValue !== oldValue) {
                    unregister();
                    if (attrs._cleanUp) {
                        attrs._cleanUp();
                    }
                    ...
                    if (elements.length > 0) {
                        switch (cmd) {
                            ...
                            case 'compile':
                                ...
                                if (self.element.injector !== undefined) {
                                    injector = self.element.injector();
                                } else {
                                    injector = angular.element($(self.element)).injector();;
                                }
        ...
        defadvice([
            ...
            return function(ev) {
                ...
                var cell, multiple, locals = {
                        kendoEvent: ev
                    },
                    elems, items, columns, colIdx;
