    ...
    (function($, undefined) {
        ...
        var Chart = Widget.extend({
            ...
            _setupSelection: function() {
                var chart = this,
                    ...
                    selection, i, axis, min, max, options;
            ...
            _mousewheel: function(e) {
                var chart = this,
                    ...
                    prevented, delta = mwDelta(e),
                    totalDelta, state = chart._navState,
                    axes, i, currentAxis, axisName, ranges = {},
            ...
            _onDataChanged: function() {
                var chart = this,
                    ...
                    seriesIx, seriesLength = series.length,
            ...
            _bindSeries: function() {
                var chart = this,
                    ...
                    seriesIx, seriesLength = series.length,
                    currentSeries, groupIx, seriesData;
                for (seriesIx = 0; seriesIx < seriesLength; seriesIx++) {
                    currentSeries = series[seriesIx];
            ...
            _bindCategoryAxisFromSeries: function(axis, axisIx) {
                var chart = this,
                    items = [],
                    result, series = chart.options.series,
                    seriesLength = series.length,
                    seriesIx, s, onAxis, data, dataIx, dataLength, dataRow, category, uniqueCategories = {},
                    getFn, dateAxis;
                for (seriesIx = 0; seriesIx < seriesLength; seriesIx++) {
                    s = series[seriesIx];
        ...
        var SeriesBinder = Class.extend({
            ...
            bindPoint: function(series, pointIx, item) {
                var binder = this,
                    ...
                    fields, fieldData, srcValueFields, srcPointFields, valueFields = binder.valueFields(series),
            ...
            _bindFromObject: function(object, fields, srcFields) {
                var value = {},
                    i, length, fieldName, srcFieldName;
                if (fields) {
        ...
        var Legend = ChartElement.extend({
            ...
            isVertical: function() {
                var legend = this,
                    ...
                    position = options.position,
                    vertical = position == CUSTOM && orientation != HORIZONTAL || (defined(orientation) ? orientation != HORIZONTAL : inArray(position, [
                        LEFT,
                        RIGHT
                    ]));
                return vertical;
        ...
        var DateCategoryAxis = CategoryAxis.extend({
            ...
            defaultBaseUnit: function(options) {
                var categories = options.categories,
                    ...
                    categoryIx, cat, diff, minDiff = MAX_VALUE,
                    lastCat, unit;
                for (categoryIx = 0; categoryIx < count; categoryIx++) {
        ...
        var DateValueAxis = Axis.extend({
            ...
            applyDefaults: function(seriesMin, seriesMax, options) {
                var axis = this,
                    ...
                    majorUnit = userMajorUnit || dataviz.ceil(dataviz.autoMajorUnit(autoMin.getTime(), autoMax.getTime()), baseUnitTime) / baseUnitTime,
        ...
        ErrorRangeCalculator.prototype = ErrorRangeCalculator.fn = {
            ...
            createValueGetter: function(series, field) {
                var data = series.data,
                    ...
                    idx, srcValueFields, valueGetter;
                if (isArray(item)) {
        ...
        var CategoricalChart = ChartElement.extend({
            ...
            addErrorBar: function(point, data, categoryIx) {
                var chart = this,
                    ...
                    errorRange, lowValue = data.fields[ERROR_LOW_FIELD],
            ...
            seriesValueAxis: function(series) {
                var plotArea = this.plotArea,
                    ...
                    axis = axisName ? plotArea.namedValueAxes[axisName] : plotArea.valueAxis;
                if (!axis) {
            ...
            categoryAxisCrossingValue: function(valueAxis) {
                var categoryAxis = this.categoryAxis,
                    ...
                    crossingValues = [].concat(options.axisCrossingValues || options.axisCrossingValue);
            ...
            traverseDataPoints: function(callback) {
                var chart = this,
                    ...
                    categoryIx, seriesIx, pointData, currentCategory, currentSeries, seriesCount = series.length;
        ...
        var LineChartMixin = {
            renderSegments: function() {
                var chart = this,
                    ...
                    currentSeries, seriesIx, seriesCount = seriesPoints.length,
                    sortedPoints, linePoints, point, pointIx, pointCount, lastSegment;
                this._segments = [];
                for (seriesIx = 0; seriesIx < seriesCount; seriesIx++) {
                    currentSeries = series[seriesIx];
        ...
        var StepLineSegment = LineSegment.extend({
            ...
            calculateStepPoints: function(points) {
                var segment = this,
                    ...
                    dir = reverse ? 2 : 1,
                    revDir = reverse ? 1 : 2,
                    prevPoint, point, i, prevMarkerBoxCenter, markerBoxCenter, result = [];
                for (i = 1; i < length; i++) {
        ...
        var AreaChart = LineChart.extend({
            createSegment: function(linePoints, currentSeries, seriesIx, prevSegment) {
                var chart = this,
                    ...
                    stackPoints, pointType, style = (currentSeries.line || {}).style;
        ...
        var ScatterChart = ChartElement.extend({
            ...
            seriesAxes: function(series) {
                var plotArea = this.plotArea,
                    xAxisName = series.xAxis,
                    xAxis = xAxisName ? plotArea.namedXAxes[xAxisName] : plotArea.axisX,
                    yAxisName = series.yAxis,
                    yAxis = yAxisName ? plotArea.namedYAxes[yAxisName] : plotArea.axisY;
                if (!xAxis) {
            ...
            reflow: function(targetBox) {
                var chart = this,
                    chartPoints = chart.points,
                    pointIx = 0,
                    point, seriesAxes, limit = !chart.options.clip;
            ...
            traverseDataPoints: function(callback) {
                var chart = this,
                    ...
                    series = options.series,
                    seriesPoints = chart.seriesPoints,
                    pointIx, seriesIx, currentSeries, currentSeriesPoints, pointData, value, fields;
        ...
        var BoxPlotChart = CandlestickChart.extend({
            ...
            updateRange: function(value, fields) {
                var chart = this,
                    axisName = fields.series.axis,
                    axisRange = chart.valueAxisRanges[axisName],
                    parts = chart.splitValue(value).concat(chart.filterOutliers(value.outliers));
        ...
        var PieChartMixin = {
            createLegendItem: function(value, point, options) {
                var chart = this,
                    ...
                    text, labelTemplate, markerColor, itemLabelOptions, pointVisible;
        ...
        var PieChart = ChartElement.extend({
            ...
            traverseDataPoints: function(callback) {
                var chart = this,
                    ...
                    currentSeries, pointData, fields, seriesIx, angle, data, anglePerValue, value, plotValue, explode, total, currentAngle, i, pointIx = 0;
                for (seriesIx = 0; seriesIx < seriesCount; seriesIx++) {
                    currentSeries = series[seriesIx];
            ...
            reflow: function(targetBox) {
                var chart = this,
                    ...
                    newBox = Box2D(box.x1, box.y1, box.x1 + minWidth, box.y1 + minWidth),
                    ...
                    leftSideLabels = [],
                    rightSideLabels = [],
                    seriesConfig, seriesIndex, label, segment, sector, r, i, c;
            ...
            createVisual: function() {
                var chart = this,
                    ...
                    points = chart.points,
                    connectorLine, count = points.length,
                    space = 4,
                    sector, angle, segment, seriesIx, label, i;
                ChartElement.fn.createVisual.call(this);
        ...
        var DonutChart = PieChart.extend({
            ...
            reflow: function(targetBox) {
                var chart = this,
                    ...
                    padding = valueOrDefault(options.padding, defaultPadding),
                    series = options.series,
                    currentSeries, seriesCount = series.length,
                    seriesWithoutSize = 0,
                    holeSize, totalSize, size, margin = 0,
                    i, r, ir = 0,
                    currentSize = 0;
                chart.seriesConfigs = [];
                padding = padding > halfMinWidth - space ? halfMinWidth - space : padding;
        ...
        var Pane = BoxElement.extend({
            ...
            createGridLines: function() {
                var pane = this,
                    ...
                    vGridLines = [],
                    hGridLines = [],
                    gridLines, i, j, axis, vertical, altAxis;
                for (i = 0; i < axes.length; i++) {
                    axis = axes[i];
        ...
        var ChartContainer = ChartElement.extend({
            ...
            _clipBox: function() {
                var container = this,
                    ...
                    axisValueField, idx, lineBox, axis;
        ...
        var PlotAreaBase = ChartElement.extend({
            ...
            createPanes: function() {
                var plotArea = this,
                    ...
                    i, panesLength = math.max(paneOptions.length, 1),
                    currentPane;
            ...
            addToLegend: function(series) {
                var count = series.length,
                    data = [],
                    i, currentSeries, text, legend = this.options.legend,
                    labels = legend.labels || {},
                    inactiveItems = legend.inactiveItems || {},
                    inactiveItemsLabels = inactiveItems.labels || {},
                    color, itemLabelOptions, markerColor, defaults, seriesVisible, labelTemplate;
                for (i = 0; i < count; i++) {
                    currentSeries = series[i];
            ...
            alignAxisTo: function(axis, targetAxis, crossingValue, targetCrossingValue) {
                var slot = axis.getSlot(crossingValue, crossingValue, true),
                    ...
                    axisBox = axis.box.translate(targetSlot[X + targetEdge] - slot[X + slotEdge], targetSlot[Y + targetEdge] - slot[Y + slotEdge]);
            ...
            fitAxes: function(panes) {
                var plotArea = this,
                    axes = plotArea.groupAxes(panes).any,
                    offsetX = 0,
                    paneAxes, paneBox, axisBox, offsetY, currentPane, currentAxis, i, j;
                for (i = 0; i < panes.length; i++) {
                    currentPane = panes[i];
            ...
            reflowAxes: function(panes) {
                var plotArea = this,
                    i, axes = plotArea.groupAxes(panes);
                for (i = 0; i < panes.length; i++) {
            ...
            reflowPanes: function() {
                var plotArea = this,
                    ...
                    i, currentPane, paneBox, remainingHeight = box.height(),
        ...
        var CategoricalPlotArea = PlotAreaBase.extend({
            ...
            aggregateCategories: function(panes) {
                var plotArea = this,
                    ...
                    processedSeries = [],
                    i, currentSeries, categoryAxis, axisPane, dateAxis;
                for (i = 0; i < series.length; i++) {
                    currentSeries = series[i];
            ...
            aggregateSeries: function(series, categoryAxis) {
                var axisOptions = categoryAxis.options,
                    ...
                    i, category, categoryIx, data, aggregator, getFn = getField,
                    outOfRangeMinIdx = util.MIN_NUM,
                    outOfRangeMinCategory, outOfRangeMaxCategory, outOfRangeMaxIdx = util.MAX_NUM,
                    outOfRangePoints = inArray(series.type, [
                        LINE,
                        VERTICAL_LINE,
                        AREA,
                        VERTICAL_AREA
            ...
            seriesPaneName: function(series) {
                var plotArea = this,
                    ...
                    axis = $.grep(axisOptions, function(a) {
            ...
            seriesCategoryAxis: function(series) {
                var plotArea = this,
                    ...
                    axis = axisName ? plotArea.namedCategoryAxes[axisName] : plotArea.categoryAxis;
                if (!axis) {
            ...
            createCategoryAxes: function(panes) {
                var plotArea = this,
                    ...
                    i, axisOptions, axisPane, categories, type, name, categoryAxis, axes = [],
                    primaryAxis;
            ...
            createValueAxes: function(panes) {
                var plotArea = this,
                    ...
                    axisOptions, axisPane, valueAxis, primaryAxis, axes = [],
                    range, axisType, defaultAxisRange, name, i;
        ...
        var XYPlotArea = PlotAreaBase.extend({
            ...
            seriesPaneName: function(series) {
                var plotArea = this,
                    ...
                    xAxis = $.grep(xAxisOptions, function(a) {
                        return a.name === xAxisName;
                    })[0],
                    yAxisName = series.yAxis,
                    yAxisOptions = [].concat(options.yAxis),
                    yAxis = $.grep(yAxisOptions, function(a) {
            ...
            createXYAxis: function(options, vertical, axisIndex) {
                var plotArea = this,
                    ...
                    axis, axisType, seriesIx, series = plotArea.series,
                    currentSeries, seriesAxisName, firstPointValue, typeSamples = [
                        axisOptions.min,
                        axisOptions.max
                    ],
                    inferredDate, i;
            ...
            createAxes: function(panes) {
                var plotArea = this,
                    options = plotArea.options,
                    axisPane, xAxesOptions = [].concat(options.xAxis),
                    xAxes = [],
        ...
        var Selection = Observable.extend({
            ...
            _tap: function(e) {
                var that = this,
                    ...
                    categoryAxis = that.categoryAxis,
                    categoryIx = categoryAxis.pointCategoryIndex(new dataviz.Point2D(coords.x, categoryAxis.box.y1)),
                    from = that._index(options.from),
                    to = that._index(options.to),
                    min = that._index(options.min),
                    max = that._index(options.max),
            ...
            move: function(from, to) {
                var that = this,
                    ...
                    leftMaskWidth, rightMaskWidth, box, distance;
                box = that._slot(from);
        ...
        SeriesAggregator.prototype = {
            aggregatePoints: function(srcPoints, group) {
                var sa = this,
                    ...
                    series = sa._series,
                    seriesFields = sa._seriesFields,
                    i, field, srcValues, value, firstDataItem = data.dataItems[0],
                    result = {};
        ...
        function applySeriesDefaults(options, themeOptions) {
            var series = options.series,
                i, seriesLength = series.length,
                seriesType, seriesDefaults = options.seriesDefaults,
        ...
        function applySeriesColors(options) {
            var series = options.series,
                ...
                i, currentSeries, seriesColor, defaults;
            for (i = 0; i < series.length; i++) {
                currentSeries = series[i];
        ...
        function groupSeries(series, data) {
            var result = [],
                nameTemplate, legacyTemplate = series.groupNameTemplate,
                groupIx, dataLength = data.length,
                seriesClone;
            if (dataLength === 0) {
        ...
        function uniqueDates(srcDates, comparer) {
            var i, dates = sortDates(srcDates, comparer),
                length = dates.length,
