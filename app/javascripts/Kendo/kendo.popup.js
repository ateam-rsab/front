        ...
        var Popup = Widget.extend({
            ...
            open: function(x, y) {
                ...
                var that = this,
                    ...
                    element = that.element,
                    options = that.options,
                    animation, wrapper, anchor = $(options.anchor),
            ...
            close: function(skipEffects) {
                var that = this,
                    options = that.options,
                    wrap, animation, openEffects, closeEffects;
                if (that.visible()) {
            ...
            _position: function(fixed) {
                var that = this,
                    ...
                    siblingContainer, parents, parentZIndex, zIndex = 10002,
                ...
                var pos = getOffset(wrapper, POSITION, anchor[0] === wrapper.offsetParent()[0]),
                    ...
                    anchorParent = anchor.offsetParent().parent('.k-animation-container,.k-popup,.k-group');
            ...
            _align: function(origin, position) {
                var that = this,
                    ...
                    appendToOffset, width = element.outerWidth(),
