    ...
    (function($, undefined) {
        ...
        var AutoComplete = List.extend({
            ...
            _selectValue: function(dataItem) {
                ...
                this._accessor(text);
                this._placeholder();
                this.$angular_scope[this.element.attr('data')] = dataItem;
            },
            _change: function() {
                var that = this;
            ...
            _keydown: function(e) {
                ...
                if (key === keys.DOWN) {
                    ...
                    that.$angular_scope.$parent[that.element.attr('k-ng-model')] = that.value();
                }
            },
            _keypress: function() {
