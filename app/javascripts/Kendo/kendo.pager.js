    ...
    (function($, undefined) {
        ...
        var Pager = Widget.extend({
            ...
            options: {
                ...
                refresh: false,
                messages: {
                    allPages: (window.convertToStatement !== undefined ? window.convertToStatement('All') : 'All'),
                    display: '{0} - {1} of {2} items',
                    empty: (window.convertToStatement !== undefined ? window.convertToStatement('No items to display') : 'No items to display'),
                    page: (window.convertToStatement !== undefined ? window.convertToStatement('Page') : 'Page'),
                    of: (window.convertToStatement !== undefined ? window.convertToStatement('of') : 'of') + ' {0}',
                    itemsPerPage: (window.convertToStatement !== undefined ? window.convertToStatement('items per page') : 'items per page'),
                    first: (window.convertToStatement !== undefined ? window.convertToStatement('Go to the first page') : 'Go to the first page'),
                    previous: (window.convertToStatement !== undefined ? window.convertToStatement('Go to the previous page') : 'Go to the previous page'),
                    next: (window.convertToStatement !== undefined ? window.convertToStatement('Go to the next page') : 'Go to the next page'),
                    last: (window.convertToStatement !== undefined ? window.convertToStatement('Go to the last page') : 'Go to the last page'),
                    refresh: (window.convertToStatement !== undefined ? window.convertToStatement('Refresh') : 'Refresh'),
                    morePages: (window.convertToStatement !== undefined ? window.convertToStatement('More pages') : 'More pages')
                }
            },
