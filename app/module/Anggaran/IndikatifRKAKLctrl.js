define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('IndikatifRKAKLctrl', ['$q', '$rootScope', '$scope','FindPasien','DateHelper','$http','$route',
        function($q, $rootScope, $scope,findPasien,dateHelper,$http,$route) {
            ...
            $http.get('module/Anggaran/dummy_json/IndikatifRKAKL.json').success(function(data) {
