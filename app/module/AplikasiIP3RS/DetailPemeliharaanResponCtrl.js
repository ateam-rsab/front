define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DetailPemeliharaanResponCtrl', ['$rootScope', '$scope', 'ModelItem', '$state','IPSRSService', 'DateHelper',
		function($rootScope, $scope, ModelItem, $state, IPSRSService, DateHelper) {
			...
			$scope.mainGridOptions = { 
				...
				columns: [
				{ field:"no",title:"No" },
				{ field:"",title:"Kebutuhan Alat" },
				{ field:"",title:"Pemeriksaan Fisik" },
				{ field:"",title:"Pemeriksaan Fungsi" }],
				editable: false
			};
			var init = function(){
