			...
			if ($scope.idRuangan == 229) {
				...
				$scope.mainGridOptions = { 
					...
					columns: [
						...
						{ field:"noOrder",title:"<h3 align=center>No Order<h3>"},
						{ field:"tglOrder",
						  template: "#= new moment(new Date(tglOrder)).format('DD-MM-YYYY') #",
						  title:"<h3 align=center>Tanggal Order<h3>", filterable: false},
						{ field:"ruanganPemesan",title:"<h3 align=center>Ruang Pemesan<h3>"},
						{ field:"userPemesan",title:"<h3 align=center>User Pemesan<h3>" },
						{ field:"noRespon",title:"<h3 align=center>No Respon<h3>" },
						{ field:"noVerifikasi",title:"<h3 align=center>No Verifikasi<h3>" },
						{ field:"keteranganLainnya",title:"<h3 align=center>Keterangan<h3>" },
						{ field:"asalSukuCadang",title:"<h3 align=center>Asal Suku Cadang<h3>"},
						{ field:"keteranganOrder",title:"<h3 align=center>Keterangan Order<h3>", filterable: false},
						{ field:"namaTeknisi",title:"<h3 align=center>Nama Teknisi<h3>" },
						{ field:"jenisProduk",title:"<h3 align=center>Kategori Perbaikan<h3>" }],
						  editable: false
				};
			} else {
				// debugger
				//Ruangan Selain IP3RS
				    ...
				    //IPSRSService.getItem("psrsPermintaanPerbaikan/get-informasi-perbaikan-keluar/", true).then(function(dat){
					    ...
					    columns: [
								{ field:"no",title:"<h3 align=center>No<h3>", filterable: false},
								{ field:"noOrder",title:"<h3 align=center>No Order<h3>"},
								{ field:"tanggalOrder",title:"<h3 align=center>Tanggal Order<h3>", filterable: false},
								{ field:"ruanganPemesan",title:"<h3 align=center>Ruangan Pemesanan<h3>"},
								{ field:"userPemesan",title:"<h3 align=center>User Pemesanan<h3>"},
								{ field:"noRespon",title:"<h3 align=center>No Respon<h3>"},
								{ field:"noVerifikasi",title:"<h3 align=center>No Verifikasi<h3>"},
								{ field:"keteranganLainnya",title:"<h3 align=center>Keterangan<h3>"},
								{ field:"asalSukuCadang",title:"<h3 align=center>Asal Suku Cadang<h3>"},
								{ field:"keteranganOrder",title:"<h3 align=center>Keterangan Order<h3>"},
								{ field:"namaTeknisi",title:"<h3 align=center>Nama Teknisi<h3>"},
								{ field:"jenisProduk",title:"<h3 align=center>Kategori Perbaikan<h3>"}],
						 editable: false
				         };
