define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('PelayananIVAdmixtureCtrl', ['ManagePasien', 'FindPasien', '$state', '$rootScope', '$scope', 'ModelItem',
        function(managePasien, findPasien, $state, $rootScope, $scope, ModelItem) {
            ...
            $scope.now = new Date();
            $scope.find = function() {
                $state.go('PelayananIVAdmixtureFind');
            }
