            ...
            function validasiIcd10(){
             ...
             $scope.saveIcd10 = function() {
                ...
                manageSarprasPhp.postDataDiagnosa($scope.objSave).then(function (e) {
                    manageServicePhp.postApi("encounter-patient?noreg="+$scope.item.noMr+"&kode="+$scope.objSave.kddiagnosa+"&display=&pasienname="+$scope.item.namaPasien+"&idpasien="+$scope.item.noMr).then(function (res) {
                        console.log(res)
                    })
                    delete $scope.item.jenisDiagnosis;
                    delete $scope.item.diagnosa;
