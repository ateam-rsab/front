define(['initialize'], function(initialize, pasienServices) {
    'use strict';
    initialize.controller('LembarPengobatanFarmasiCtrl', ['ManagePasien', 'FindProduk', '$rootScope', '$scope', 'ModelItem', '$state', 'FindPasien', 'CacheHelper', 'FindPegawai',
        ...
        function(managePasien, findProduk, $rootScope, $scope, ModelItem, $state, findPasien, cacheHelper, findPegawai) {
            ...
            $scope.selesaiRacikan = function() {
                ...
                var tempDatariwayat = {
                    ...
                    "route": $scope.tempItem.route,
                    "keteranganPakai": $scope.tempItem.Keterangan,
                }
