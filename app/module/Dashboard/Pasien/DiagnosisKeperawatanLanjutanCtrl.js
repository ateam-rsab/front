// duplicate from DashboardDiagnosisKeperawatanCtrl
define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DiagnosisKeperawatanLanjutanCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'ManagePasien', 'FindPasien',
        function($rootScope, $scope, ModelItem, $state, managePasien, findPasien) {
            ...
            findPasien.getMasterDiagnosis().then(function(data){
                ...
                $scope.dataDaftarDiagnosis = new kendo.data.DataSource({
                    ...
                    //             tglAwal: {type: "date"},
                    //             namaDiagnosaKep: {type: "string", editable: false},
                    //             tglAkhir: {type: "date"},
                    //         }
                    //     }
                    // }
            ...
            $scope.opsiDiagnosis = { 
                ...
                columns: [
                    ...
                    { field:"tglAkhir", title:"Tanggal Teratasi", editor: dateTimeEditor, width: 200, type: "date", format: "{0:dd/MM/yyyy hh:mm:ss}"}
                ],
                editable: true,
                selectable: true
            };
