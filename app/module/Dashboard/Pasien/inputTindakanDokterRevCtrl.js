define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('inputTindakanDokterRevCtrl', ['ManagePasien', 'socket', '$parse', '$state', 'FindPasien', '$rootScope', '$scope', 'ModelItem', 'DateHelper', '$document', 'R', 'CacheHelper',
        function(managePasien, socket, $parse, $state, findPasien, $rootScope, $scope, ModelItem, DateHelper, $document, r, cacheHelper) {
            ...
            function LoadCacheHelper(){
                var chacePeriode = cacheHelper.get('inputTindakanDokterRevCtrl');
