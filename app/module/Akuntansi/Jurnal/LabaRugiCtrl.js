define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('LabaRugiCtrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            loadCombo();
            function LoadCache(){
              var chacePeriode = cacheHelper.get('LabaRugiCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('LabaRugiCtrl', chacePeriode);
