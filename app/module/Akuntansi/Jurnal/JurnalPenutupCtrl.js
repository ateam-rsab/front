define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('JurnalPenutupCtrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            loadCombo();
            function LoadCache(){
              var chacePeriode = cacheHelper.get('JurnalPenutupCtrl');
            ...
            function init() {
                ...
                manageAkuntansi.getDataTableTransaksi("akuntansi/get-data-group-COA?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir 
                ...
                cacheHelper.set('JurnalPenutupCtrl', chacePeriode);
