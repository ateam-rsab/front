define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('AkuntansiPendapatanRev1Ctrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            function init() {
                ...
                // }
                var level ="&namalaporan=Rincian Pendapatan" //+$scope.item.level.id
