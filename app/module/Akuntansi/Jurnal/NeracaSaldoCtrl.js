define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('NeracaSaldoCtrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            loadCombo();
            function LoadCache(){
              var chacePeriode = cacheHelper.get('NeracaSaldoCtrl');
            ...
            function init() {
                ...
                cacheHelper.set('NeracaSaldoCtrl', chacePeriode);
