define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('AkuntansiArusKasRev1Ctrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            function init() {
                ...
                // }
                var level ="&namalaporan=Arus Kas" //+$scope.item.level.id
