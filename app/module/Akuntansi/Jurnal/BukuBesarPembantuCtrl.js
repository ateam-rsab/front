define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('BukuBesarPembantuCtrl', ['$sce', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'ManageAkuntansi','DateHelper','CacheHelper',
        function($sce, $q, $rootScope, $scope, modelItemAkuntansi, manageAkuntansi,dateHelper,cacheHelper) {
            ...
            function LoadData(){
                ...
                // });
                //debugger;
                modelItemAkuntansi.getDataTableTransaksi("akuntansi/get-data-buku-besar-pembantu?"+ jp + "&tglAwal=" + tglAwal + "&tglAkhir=" + tglAkhir + bb ).then(function(data){
