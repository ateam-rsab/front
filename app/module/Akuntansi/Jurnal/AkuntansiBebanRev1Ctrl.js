define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('AkuntansiBebanRev1Ctrl', ['$q', '$rootScope', '$scope', 'ManageAkuntansi','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageAkuntansi,$state,cacheHelper,dateHelper) {
            ...
            function init() {
                ...
                // }
                var level ="&namalaporan=Rincian Beban" //+$scope.item.level.id
