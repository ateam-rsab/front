...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('SetoranKasirPHPCtrl', ['$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'MnKeu','DateHelper','$state','CacheHelper','ManageKasir','$mdDialog',
             	 	...
             	 	$q.all([
              			...
              			// ]).then(function(data) {
              				...
              				if (data[0].statResponse){ 
	              				...
	              				// $scope.DetailSetor =data[0].data.data.details;
              			...
              			// if (dataResult[i].status != 'Setor') {
              				...
              				if (adaDetail == 0) {
              					...
              					if (dataDetail0.length > 0){
              						dataDetail = {caraBayar: dataResult[i].caraBayar,
