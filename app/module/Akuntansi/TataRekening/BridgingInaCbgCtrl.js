			...
			$scope.set_claim_data = function () {
				...
				let data = {
					...
					data: {
						nomor_sep: $scope.dataPasienSelected.nosep,
						nomor_kartu: $scope.dataPasienSelected.nokepesertaan,
						tgl_masuk: $scope.dataPasienSelected.tglregistrasi,
						tgl_pulang: $scope.dataPasienSelected.tglpulang,
						jenis_rawat: $scope.dataPasienSelected.deptid != 16 ? 2 : 1,
						kelas_rawat: $scope.dataPasienSelected.nokelasdaftar,
						adl_sub_acute: '',
						adl_chronic: '',
						icu_indikator: '',
						icu_los: '',
						ventilator_hour: '',
						upgrade_class_ind: $scope.dataPasienSelected.nokelasdijamin != $scope.dataPasienSelected.nokelasdaftar ? 1 : 0,
						upgrade_class_class: $scope.dataPasienSelected.nokelasdijamin != $scope.dataPasienSelected.nokelasdaftar ? $scope.dataPasienSelected.namakelas : '',
						upgrade_class_los: '',
						add_payment_pct: '',
						birth_weight: '',
						discharge_status: discharge_status,
						diagnosa: $scope.dataPasienSelected.icd10,
						procedure: $scope.dataPasienSelected.icd9,
						tarif_rs: {
						...
						tarif_poli_eks: $scope.dataPasienSelected.tarif_poli_eks ? $scope.dataPasienSelected.tarif_poli_eks : "",
						nama_dokter: $scope.dataPasienSelected.namadokter,
						kode_tarif: $scope.dataPasienSelected.kodetarif,
						payor_id: "3",
						payor_cd: "JKN",
						cob_cd: "#",
						coder_nik: $scope.dataPasienSelected.codernik
					}
				}
