	...
	initialize.controller('PengelolaanRekeningBridgingCtrl', ['$sce', '$q', '$rootScope', '$scope', '$http', 'ModelItemAkuntansi', 'ManageAkuntansi','DateHelper','CacheHelper',
		function($sce, $q, $rootScope, $scope, $http, modelItemAkuntansi, manageAkuntansi,dateHelper,cacheHelper) {
			...
			$scope.init = () => {
				...
				manageAkuntansi.getDataTableTransaksi(`akuntansi/get-pengelolaan-rek-bridge?tglAwal=${tglAwal}&tglAkhir=${tglAkhir}`)
				.then(res => {		
			...
			$scope.cariFilter = () => {
				...
				manageAkuntansi.getDataTableTransaksi(`akuntansi/get-pengelolaan-rek-bridge?tglAwal=${tglParAwal}&tglAkhir=${tglParAkhir}`).then((res) => {
					// data table
			...
			$scope.sendData = () => {
				...
				$scope.postListPengelolaanRekening = () => {
					manageAkuntansi.postpost(body, 'akuntansi/add-pengelolaan-rek-bridge')
					.then(res => {
						console.log(res);
						$scope.init();
					})
