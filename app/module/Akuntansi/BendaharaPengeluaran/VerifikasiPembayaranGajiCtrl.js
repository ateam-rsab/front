define(['initialize'], function(initialize) {
  'use strict';
  initialize.controller('VerifikasiPembayaranGajiCtrl', ['CacheHelper','$timeout', '$q', '$rootScope', '$scope', 'MnKeu', '$state','DateHelper',
    function(cacheHelper,$timeout, $q, $rootScope, $scope, mnKeu,$state,dateHelper) {
      ...
      function loadData(){
       ...
       if($scope.item.status == undefined){
        ...
        mnKeu.getUrlData(urlString + tglAwal1 + 
          "&dateEnd=" + tglAkhir1 +nf+nr).then(function(data) {
