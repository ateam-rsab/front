define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('PaketObatPasienCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper) {
           ...
           function init() {
            ...
            manageLogistikPhp.getDataTableTransaksi("logistik-stok/get-data-combo-transfer", true).then(function(dat){
                ...
                manageLogistikPhp.getDataTableTransaksi("logistik-stok/get-detail-ruangan-apd?norec_apd="+norec_apd, true).then(function(dat){
