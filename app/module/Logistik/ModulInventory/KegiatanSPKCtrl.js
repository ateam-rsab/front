define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('KegiatanSPKCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','ModelItemAkuntansi',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,modelItemAkuntansi) {
            ...
            // init();
            function LoadCache(){
               var chacePeriode = cacheHelper.get('KegiatanSPKCtrl');
