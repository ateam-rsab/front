define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('EditKegiatanSPKCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','ModelItemAkuntansi',
                    ...
                    if (noOrder != '') {
                        if (noOrder == 'EditTerima') {
                            manageLogistikPhp.getDataTableTransaksi("spk/get-detail-SPPB?norecOrder="+norecResep, true).then(function(data_ih){                       
                                $scope.item.koordinator={id:data_ih.data.detail.jenisusulanid , jenisusulan:data_ih.data.detail.keteranganlainnya} 
                                $scope.item.tglUsulan=data_ih.data.detail.tglusulan 
                                $scope.item.tglKontrak=data_ih.data.detail.tglkontrak
                                ...
                                $scope.item.keteranganUsulan = data_ih.data.detail.keterangan
                                $scope.item.mataAnggaran = {mataanggaran:data_ih.data.detail.mataanggaran, norec:data_ih.data.detail.objectmataanggaranfk}
