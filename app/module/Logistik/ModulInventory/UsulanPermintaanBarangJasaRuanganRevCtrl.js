define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('UsulanPermintaanBarangJasaRuanganRevCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp', '$state', 'CacheHelper', 'ModelItemAkuntansi',
        function ($q, $rootScope, $scope, manageLogistikPhp, $state, cacheHelper, modelItemAkuntansi) {
                            ...
                            manageLogistikPhp.getDataTableTransaksi("sppb/get-detail-SPPB?norecOrder=" + norecResep, true).then(function (data_ih) {
                                ...
                                if (data_ih.data.detail != undefined) {
                                    ...
                                    $scope.item.mengetahui = {
                                        id: data_ih.data.detail.petugasmengetahuiid,
                                        namalengkap: data_ih.data.detail.petugasmengetahui
                                    };
            ...
            $scope.simpan = function () {
                ...
                manageLogistikPhp.saveDataProduk2(objSave, "usulan-permintaan/ruangan/save-usulan-permintaan-ruangan").then(function (e) {
