define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarPengajuanPengadaanBarangCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','DateHelper','ModelItemAkuntansi',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,dateHelper,modelItemAkuntansi) {
            ...
            function LoadCache(){
              var chacePeriode = cacheHelper.get('DaftarPengajuanPengadaanBarangCtrl');
            ...
            function loadCombo(){
                ...
                manageLogistikPhp.getDataTableTransaksi("usulan-permintaan/ruangan/get-data-combo", true).then(function(dat){
                    ...
                    if (pegawaiUser == 27 || pegawaiUser == 21) {
                        $scope.button1 =true;
                        $scope.button = false;
                        init();
            ...
            function init() {
                ...
                cacheHelper.set('DaftarPengajuanPengadaanBarangCtrl', chacePeriode);
