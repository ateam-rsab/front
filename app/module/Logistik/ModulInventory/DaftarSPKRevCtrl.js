define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('DaftarSPKRevCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp', '$state', 'CacheHelper', 'DateHelper', 'ModelItemAkuntansi', '$mdDialog',
        function ($q, $rootScope, $scope, manageLogistikPhp, $state, cacheHelper, dateHelper, modelItemAkuntansi, $mdDialog) {
            ...
            function init() {
                ...
                manageLogistikPhp.getDataTableTransaksi("upk/get-daftar-spk?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
            ...
            $scope.columnGrid = [{
                ...
                },
                {
                    ...
                    "title": "Tanggal",
                    "width": "58px",
                    "template": "<span class='style-right'>{{formatTanggal('#: tglorder #', 'DD-MM-YYYY')}}</span>"
                },
                // {
                //     "field": "supplier",
                //     "title": "Supplier",
            ...
            $scope.opsiGridSip = {
                toolbar: [
                    ...
                    // },
                    {
                        text: "export",
                        name: "Export detail",
                        template: '<button ng-click="Cetak()" class="k-button k-button-icontext k-grid-upload"><span class="k-icon k-print"></span>Cetak</button>'
                    }
                ],
                filterable: {
                    extra: false,
            ...
            $scope.exportSPK = function () {
                ...
                tempDataExport.fetch(function () {
                    ...
                    kendo.saveAs({
                        ...
                        fileName: "Daftar Surat Perintah Kerja (SPK).xlsx"
                    });
                });
            }
