define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('UbahPenerimaanBarangSuplierCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp', '$state', 'CacheHelper', 'ModelItemAkuntansi', '$mdDialog',
        function ($q, $rootScope, $scope, manageLogistikPhp, $state, cacheHelper, modelItemAkuntansi, $mdDialog) {
            ...
            function LoadCache() {
                ...
                var chacePeriode = cacheHelper.get('UbahPenerimaanBarangSuplierCtrl');
                    ...
                    if (noOrder != '') {
                        ...
                        if (noOrder == 'EditTerima') {
                            ...
                            manageLogistikPhp.getDataTableTransaksi("penerimaan-suplier/get-detail-terima-barang-suplier?norec=" + norecTerima, true).then(function (data_ih) {
                                ...
                                kelTrans = 35;
                                $scope.item.koordinator = {
                                    id: data_ih.data.detailterima.jenisusulanfk,
                                    jenisusulan: data_ih.data.detailterima.jenisusulan
                                };
            ...
            $scope.simpan = function () {
                ...
                $mdDialog.show(confirm).then(function () {
                    $scope.SaveUbahPenerimaan();
                })

            }

            $scope.SaveUbahPenerimaan = function () {
                $scope.saveShow = false;
                // $scope.saveShow = ;        
                var rkk = null
                ...
                manageLogistikPhp.postUbahPenerimaan(objSave).then(function (e) {
                    NorecCetak = e.data.data
                    var forSave = {
                        struk: struk,
                        norec: NorecCetak,
                        details: data2
