...
define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarDistribusiBarangReturCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','DateHelper','ModelItemAkuntansi',
                            ...
                            for (var j = 0; j < datBatal.length; j++) {
                                 if (datBatal[j].statCheckbox ==true) {
                                    if (datBatal[j].objectprodukfk == datas[i].kdeproduk) {
                                        if (datBatal[j].qtyproduk < datas[i].qtyproduk) {
                                           jumlah = i + 1;
                                           Cek = j + 1;
                                        }
                                    }
