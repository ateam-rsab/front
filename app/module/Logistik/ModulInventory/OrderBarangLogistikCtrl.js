define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('OrderBarangLogistikCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','$mdDialog', 'ModelItemAkuntansi',
            ...
            manageLogistikPhp.getDataTableTransaksi("logistik-stok/get-data-combo-transfer", true).then(function(dat){
                ...
                if (noOrder != '') {
                    if (noOrder == 'EditOrder') {
                        manageLogistikPhp.getDataTableTransaksi("logistik-stok/get-detail-order-barang?norecOrder="+norecOrder, true).then(function(data_ih){
        ...
        // ];
            ...
            $scope.SaveOrder = function(){
                ...
                manageLogistikPhp.postorderbarang(objSave).then(function(e) {
                    ...
                    // }
                    // var client = new HttpClient();
                    // client.get('http://127.0.0.1:1237/printvb/logistik?cetak-bukti-order=1&nores='+norecCetak+'&view=true&user='+pegawaiUser.namalengkap, function(response) {
                    //     //aadc=response;
                    // });
                    // window.history.back();
                    Kosongkan();
