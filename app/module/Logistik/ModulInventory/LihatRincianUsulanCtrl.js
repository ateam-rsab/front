define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('LihatRincianUsulanCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','ModelItemAkuntansi','ModelItem','$window','$mdDialog','ManageServicePhp',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,modelItemAkuntansi,ModelItem,window, $mdDialog, manageServicePhp) {
            ...
            // init();
            function LoadCache(){
               var chacePeriode = cacheHelper.get('LihatRincianUsulanCtrl');
        ...
        $scope.columnGrid = [
            ...
            $scope.Batal1 = function(){
             ...
             $scope.SimpanVerif = function(){
                ...
                manageLogistikPhp.postverifikasiusulan(objSave).then(function(e) {
                    $scope.item.Status = undefined;
                    $scope.item.Keterangan = '';
                    $scope.PopUpVerifikasi.close();
                })        
