define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('SaldoBarangDetailv2Ctrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','DateHelper','ModelItemAkuntansi',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,dateHelper,modelItemAkuntansi) {
            ...
            function init() {
                ...
                manageLogistikPhp.getDataTableTransaksi("logistik-stok/get-daftar-stock-flow?"+
                    "tglawal=" + tglAwal + 
                    "&tglakhir=" + tglAkhir +
                    "&ruanganfk=" + rg +
