define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarHargaPerkiraanSendiriCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','DateHelper','ModelItemAkuntansi',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,dateHelper,modelItemAkuntansi) {
            ...
            loadCombo();
            function LoadCache(){
              var chacePeriode = cacheHelper.get('DaftarHargaPerkiraanSendiriCtrl');
            ...
            function init() {
                ...
                manageLogistikPhp.getDataTableTransaksi("data-hps/get-daftar-Pengadaan?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
                ...
                cacheHelper.set('DaftarHargaPerkiraanSendiriCtrl', chacePeriode);
