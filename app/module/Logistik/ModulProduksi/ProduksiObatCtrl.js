define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('ProduksiObatCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper',
        ...
        // ];
            ...
            $scope.simpan = function(){
                ...
                manageLogistikPhp.postproduksibarang(objSave).then(function(e) {
