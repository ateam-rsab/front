define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('MasterKontrakKerja(PerTahun)Ctrl', ['$rootScope', '$scope', 'ModelItem',
		function($rootScope, $scope, ModelItem, DateHelper, $document, r) {		
			...
			$scope.now = new Date();
			ModelItem.get("InformasidanPerencanaanRumahSakit/MasterKontrakKerja(PerTahun)").then(function(data) {
				$scope.item = data;
				scope.dataVOloaded = true;
