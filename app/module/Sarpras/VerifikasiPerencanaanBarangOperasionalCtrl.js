...
define(['initialize'], function (initialize) {
    ...
    'use strict';
    initialize.controller('VerifikasiPerencanaanBarangOperasionalCtrl', ['$rootScope', '$scope', 'ModelItem','DateHelper','$state',
        function ($rootScope, $scope, ModelItem, DateHelper,$state) {
            $scope.title = "Verifikasi Perencanaan Barang Operasional (Pengendali Kegiatan)";
            $scope.dataVOloaded = true;
            $scope.item = {};
                        
            ModelItem.get("VerifikasiPerencanaanBarangOperasional").then(function(data) {
                $scope.item = data;
                $scope.dataVOloaded=true;
