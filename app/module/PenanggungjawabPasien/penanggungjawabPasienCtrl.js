   ...
   initialize.controller('PenanggungjawabPasienCtrl', ['$rootScope', '$scope', 'ModelItem',	
   	function($rootScope, $scope, ModelItem) {
	    ...
	    $scope.test = function() {
			...
			var arrFieldSelectVoNegara = ['id', 'hubunganKeluarga'];
			ModelItem.getKendoSource("HubunganKeluarga", arrFieldSelectVoNegara).then(function(data){
				$scope.listDataHubunganKeluarga = data;
			})
			
			var arrFieldSelectVoNegara = ['id', 'name'];
			ModelItem.getKendoSource("JenisIdentitas", arrFieldSelectVoNegara).then(function(data){
				$scope.listJenisIdentitas = data;
			})
