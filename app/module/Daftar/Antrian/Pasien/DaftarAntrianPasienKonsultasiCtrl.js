define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarAntrianPasienKonsultasiCtrl', ['$interval', 'SaveToWindow', '$rootScope', '$scope', 'ModelItem', '$state', 'FindPasien', 'DateHelper', 'socket', 'ManagePasien',
        function($interval, saveToWindow, $rootScope, $scope, ModelItem, $state, findPasien, dateHelper, socket, managePasien) {
            ...
            $scope.group = {
                field: "konsultasi.tujuanKonsultasi.namaRuangan",
                aggregates: [{
                    field: "pasien",
                    aggregate: "count"
                }, {
            ...
            $scope.findData = function() {
                ...
                findPasien.findQueueKonsul($scope.from, $scope.until, $scope.ruangan, $scope.namaPasien).then(function(e) {
                    debugger;
