define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('KelompokUserCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
		function($q, $rootScope, $scope, IPSRSService) {
			...
			var init = function () {
				IPSRSService.getFieldsMasterTable("get-data-master?className=KelompokUser", true).then(function(dat){
					$scope.listDataMaster = dat.data.data.KelompokUser;
			...
			$scope.mainGridOptions = { 
                pageable: true,
                columns: $scope.columnKelompokUser,
                editable: "popup",
                selectable: "row",
                scrollable: false
            };
			...
			$scope.disableData=function(){
				IPSRSService.getClassMaster("delete-master-table?className=KelompokUser&&id="+$scope.item.id+"&&statusEnabled=false").then(function(dat){
					// debugger;
					init();
