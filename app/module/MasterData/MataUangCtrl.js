...
initialize.controller('MataUangCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.currentKursToIDR = current.currentKursToIDR;
$scope.item.kdMataUang = current.kdMataUang;
$scope.item.mataUang = current.mataUang;
$scope.item.qMataUang = current.qMataUang;
