define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('PemakaiandanPemanasanMesinBoilerCtrl', ['$rootScope', '$scope', '$window', 'ModelItem', 'DateHelper', 'PemakaiandanPemanasanMesinService',
		function ($rootScope, $scope, $window, ModelItem, DateHelper, PemakaiandanPemanasanMesinService) {
			...
			var init = function () {
				PemakaiandanPemanasanMesinService.findAllPemakaianMesin("ipsrs-pemakaian-mesin/pemakaian-mesin-boiler").then(function success(dat) {
			...
			$scope.optGridPemanasanGenset = {
				dataSource: $scope.dataPemanasanGenset,
				pageable: true,
				columns: $scope.columnPemanasanGenset
			}
   ...
   //          });
			...
			$scope.cari = function () {
				...
				PemakaiandanPemanasanMesinService.findAllPemakaianMesin("ipsrs-pemakaian-mesin/pemakaian-mesin-boiler?" + url).then(function (dat) {
					$scope.dataPemanasanGenset = dat.data.data;
					// //debugger;
