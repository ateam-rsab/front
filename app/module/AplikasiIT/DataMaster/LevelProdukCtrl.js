...
initialize.controller('LevelProdukCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdLevelProduk = current.kdLevelProduk;
$scope.item.levelProduk = current.levelProduk;
$scope.item.qLevelProduk = current.qLevelProduk;
