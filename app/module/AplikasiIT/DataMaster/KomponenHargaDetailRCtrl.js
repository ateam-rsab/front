...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('KomponenHargaDetailRCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.klik = function(current){
	...
	$scope.item.namaKomponenHargaDetailR = current.namaKomponenHargaDetailR;
	$scope.item.noUrut = current.noUrut;
	$scope.item.qKomponenHargaDetailR = current.qKomponenHargaDetailR;
