...
initialize.controller('DetailGolonganProdukCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdDetailGolonganProduk = current.kdDetailGolonganProduk;
$scope.item.kelompokProduk = current.kelompokProduk;

$scope.item.qDetailGolonganProduk = current.qDetailGolonganProduk;
...
$scope.disableData=function(){
 IPSRSService.getClassMaster("delete-master-table?className=DetailGolonganProduk&&id="+$scope.item.id+"&&statusEnabled=false").then(function(dat){
 init();
 });
 };
$scope.enableData=function(){
 IPSRSService.getClassMaster("delete-master-table?className=DetailGolonganProduk&&id="+$scope.item.id+"&&statusEnabled=true").then(function(dat){
 init();
