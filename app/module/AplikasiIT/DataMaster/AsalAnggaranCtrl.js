...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('AsalAnggaranCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.klik = function(current){
	...
	$scope.item.asalAnggaran = current.asalAnggaran;
	$scope.item.kdAsalAnggaran = current.kdAsalAnggaran;
	$scope.item.keterangan = current.keterangan;
	$scope.item.qAsalAnggaran = current.qAsalAnggaran;
