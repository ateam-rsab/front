define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('HargaNettoProdukByKelasVaksinCtrl', ['$q', '$rootScope', '$state', '$scope', 'IPSRSService', 'ModelItemAkuntansi', 'CacheHelper', 'ManageAkuntansi',
		function ($q, $rootScope, $state, $scope, IPSRSService, modelItemAkuntansi, cacheHelper, ManageAkuntansi) {
			...
			var init = function () {
				...
				modelItemAkuntansi.getDataTableMaster("tarif/harganettoprodukbykelas-vaksin", true).then(function (dat) {
					var no = 0;
