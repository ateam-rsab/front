...
initialize.controller('KategoryProdukCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdKategoryProduk = current.kdKategoryProduk;
$scope.item.kelompokProduk = current.kelompokProduk;
$scope.item.kelompokProdukId = current.kelompokProdukId;
$scope.item.qKategoryProduk = current.qKategoryProduk;
...
$scope.disableData=function(){
 IPSRSService.getClassMaster("delete-master-table?className=KategoryProduk&&id="+$scope.item.id+"&&statusEnabled=false").then(function(dat){
 init();
 });
 };
$scope.enableData=function(){
 IPSRSService.getClassMaster("delete-master-table?className=KategoryProduk&&id="+$scope.item.id+"&&statusEnabled=true").then(function(dat){
 init();
