...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('KomponenHargaRCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.klik = function(current){
	...
	$scope.item.namaKomponenHargaR = current.namaKomponenHargaR;
	$scope.item.noUrut = current.noUrut;
	$scope.item.qKomponenHargaR = current.qKomponenHargaR;
