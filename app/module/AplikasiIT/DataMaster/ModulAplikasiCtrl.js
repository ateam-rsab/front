define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('ModulAplikasiCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
		function($q, $rootScope, $scope, IPSRSService) {
			$scope.item = {};
			$scope.dataVOloaded = true;
			$scope.now = new Date();
			var init = function () {
				IPSRSService.getFieldListData("ModulAplikasi&select=id,modulAplikasi,reportDisplay,kodeExternal,namaExternal,noRec,statusEnabled,kdModulAplikasi", true).then(function(dat){
