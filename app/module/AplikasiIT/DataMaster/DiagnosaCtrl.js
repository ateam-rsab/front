...
'use strict';
initialize.controller('DiagnosaCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdDiagnosa = current.kdDiagnosa;
$scope.item.jenisKelamin = current.jenisKelamin;

$scope.item.kategoryDiagnosa = current.kategoryDiagnosa;

$scope.item.namaDiagnosa = current.namaDiagnosa;
$scope.item.qDiagnosa = current.qDiagnosa;
