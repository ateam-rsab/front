...
'use strict';
initialize.controller('KategoryDiagnosaCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdKategoryDiagnosa = current.kdKategoryDiagnosa;
$scope.item.qKategoryDiagnosa = current.qKategoryDiagnosa;
$scope.item.rincianKodeDiagnosa = current.rincianKodeDiagnosa;
