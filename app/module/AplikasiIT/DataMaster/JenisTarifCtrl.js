define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('JenisTarifCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
		function($q, $rootScope, $scope, IPSRSService) {
            ...
            $scope.klik = function(current){
				...
				$scope.item.kdJenisTarif = current.kdJenisTarif;
				$scope.item.qJenisTarif = current.qJenisTarif;
