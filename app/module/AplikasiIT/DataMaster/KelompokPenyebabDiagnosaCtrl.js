...
'use strict';
initialize.controller('KelompokPenyebabDiagnosaCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdKelompokPDiagnosa = current.kdKelompokPDiagnosa;
$scope.item.kelompokPDiagnosa = current.kelompokPDiagnosa;
$scope.item.qKelompokPDiagnosa = current.qKelompokPDiagnosa;
