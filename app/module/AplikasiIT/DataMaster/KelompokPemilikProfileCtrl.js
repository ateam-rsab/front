define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('KelompokPemilikProfileCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
		function($q, $rootScope, $scope, IPSRSService) {
            ...
            $scope.klik = function(current){
				...
				$scope.item.kdKelompokPemilik = current.kdKelompokPemilik;
				$scope.item.kelompokPemilik = current.kelompokPemilik;
				$scope.item.qKelompokPemilik = current.qKelompokPemilik;
