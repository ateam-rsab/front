define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('ProdukCtrl', ['$q', '$rootScope', '$scope','$state','ManageLogistikPhp','ModelItem','$mdDialog',
		function($q, $rootScope, $scope,$state,ManageLogistikPhp,ModelItem,$mdDialog) {
			$scope.item = {};
