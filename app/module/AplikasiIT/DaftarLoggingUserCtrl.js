define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarLoggingUserCtrl', ['$rootScope', '$scope', 'ModelItem','IPSRSService','$state','ManageSarpras','ModelItemAkuntansi','ManageServicePhp','ManageLogistikPhp','DateHelper','CacheHelper',
		function($rootScope, $scope, ModelItem,IPSRSService,$state,ManageSarpras,modelItemAkuntansi,manageServicePhp,manageLogistikPhp,dateHelper,cacheHelper) {
            ...
            manageServicePhp.getDataTableTransaksi('logging/get-data-combo').then(function(e) {
            ...
            $scope.listJenisLog = [
                ...
                {
                    id:88,
                    jenis:'Pembayaran Tagihan Pasien'
                },
                {
                    id:8,
			...
			function GetData(){
                ...
                manageLogistikPhp.getDataTableTransaksi("logging/Daftar-log-user?"
                    +"tglAwal="+tglAwal+
                    "&tglAkhir="+tglAkhir
