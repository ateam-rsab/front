define(['kendo.menu'], function (kendoMenu) {
    ...
    function HeaderCtrl($window, $scope, MenuService, GlobalToState, $rootScope, $state, LoginHelper, $location, socket) {
        ...
        $scope.imgProfile = localStorage.getItem('imgProfile');
        ...
        // const baseURLServiceImage = window.location.hostname === "localhost" || window.location.hostname === "192.168.12.3" ? "192.168.12.3" : "192.168.12.2";
        // // http://192.168.12.3:8080/jasamedika-sdm/pegawai/get-avatar?pegawaiId=22349
        // const url = `${window.location.protocol}//${baseURLServiceImage}:8080/jasamedika-sdm/pegawai/get-avatar?pegawaiId=${$scope.pegawai.id}?X-AUTH-TOKEN=${token}`;
        // $.ajax({
        //     url: url,
        //     method: "GET",
        //     success: (data) => {
        //         console.log(data);
        //         $scope.imgProfile = data.data.data;
        //     }
        // })
