define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DaftarPasienLaboratoriumCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','DateHelper',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,dateHelper) {
            ...
            $scope.TransaksiPelayanan = function(){
                ...
                cacheHelper.set('TransaksiPelayananLaboratoriumCtrl', arrStr);
                $state.go('TransaksiPelayananLaboratorium')
            }
