define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('TransaksiPelayananLaboratoriumCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','ManagePasien',
        function($q, $rootScope, $scope,manageLogistikPhp,$state,cacheHelper,managePasien) {
            $scope.item = {};
            ...
            LoadCache();
            function LoadCache(){
                var chacePeriode = cacheHelper.get('TransaksiPelayananLaboratoriumCtrl');
        ...
        function init() {
            ...
            manageLogistikPhp.getDataTableTransaksi("pelayanan/get-list-pelayanan?departemenfk=3&nocm="+$scope.item.noMr, true).then(function(dat){
