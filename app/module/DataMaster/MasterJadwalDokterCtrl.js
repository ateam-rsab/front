define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('MasterJadwalDokterCtrl', ['$q', '$rootScope', '$scope'
		...
		function($q, $rootScope, $scope, manageSarprasPhp,$state,cacheHelper,dateHelper, modelItemAkuntansi) {
			...
			$scope.columnGrid = {
				...
				excelExport: function(e){
	             ...
	             columns:	[ 
	             {  
	             	field: "namaruangan",title: "Ruangan",width:"250px" 
	             },
	             {  
	             	field: "namahari",title: "Hari",width:"100px" 
	             },
	             {  
	             	field: "jampraktek",title: "Jam Praktek",width:"100px" 
	             },
	             {  
	             	field: "namalengkap", title: "Dokter", width:"300px" 
	             }, 
	             {  
	             	field: "quota", title: "quota", width:"75px" 
	             },
	             {
	             	command:[
	             	{ 
	         ...
	         function changeRow(e){
	         	...
	         	$scope.item.ruangan2 = {id:dataItem.idruangan,namaruangan:dataItem.namaruangan};
	         	$scope.item.hari2 = {id:dataItem.idhari,namahari:dataItem.namahari};
	         	$scope.listDokter.add({id:dataItem.idpeg,namalengkap:dataItem.namalengkap}); 
	         	$scope.item.dokter =  {id:dataItem.idpeg,namalengkap:dataItem.namalengkap}; 
	         	$scope.item.jam ={id:dataItem.idjampraktek,jampraktek:dataItem.jampraktek};
	         ...
	         $scope.createNew = function(){  
				...
				// Set the new options
				$scope.popUpJadwal.setOptions({ actions : actions });
			};
			...
			function loadComboPopup(){ 
				...
				modelItemAkuntansi.getDataDummyPHP("jadwaldokter/get-drop-down-pegawai"
					, true, true, 10).then(function(data) {
			...
			function loadData(){
				...
				manageSarprasPhp.getDataTableTransaksi("humas/get-data-jadwal?ruangan=" + rd + "&hari=" + hr ).then(function(data) {
