define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('PersetujuanUmumCtrl', ['ManagePasien', '$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'FindPasien',
        function(managePasien, $rootScope, $scope, ModelItem, $state, dateHelper, findPasien) {
            ...
            ModelItem.getDataDummyGeneric("KelompokPasien", true).then(function(data) {
                $scope.listJenisPembayaran = data;
            });
