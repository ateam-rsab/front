define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('PermintaanBarangNonMediskeLogistikCtrl', ['$rootScope', '$scope', 'ModelItem', 'DateHelper', '$document', 'R',
		function($rootScope, $scope, ModelItem, DateHelper, $document, r) {		
			...
			$scope.now = new Date();
			ModelItem.get("Humas/PermintaanBarangNonMediskeLogistik").then(function(data) {
				$scope.item = data;
				scope.dataVOloaded = true;
