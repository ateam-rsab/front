define(['initialize'], function(initialize) {
	'use strict';
	 initialize.controller('DataPerusahaanBekerjasamaCtrl', ['$rootScope', '$scope', 'ModelItem', 'DataPerusahaanBekerjasama' ,'TampilDataPerusahaanBekerjasama', 'ManageSarpras', '$state',
