...
define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPengeluaranSetoranCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManageSdm',  'DateHelper','InformasiRuangan','InformasiKelompokTransaksi','InformasiPegawaiTujuan','InformasiPegawaiPenerima','$mdDialog', '$state',
		function($rootScope, $scope, ModelItem, ManageSdm, DateHelper,InformasiRuangan,InformasiKelompokTransaksi,InformasiPegawaiTujuan,InformasiPegawaiPenerima,$mdDialog,$state) {
			...
			$scrollable : true
			  ...
			  $scope.Cari = function(){
                ...
                ManageSdm.getItem("terimakeluarkaskecil/get-filter-data-by-from-to-kaskeluar?id=60&from="+tglAwal+"&to="+tglAkhir, true).then(function(dat){
                debugger
