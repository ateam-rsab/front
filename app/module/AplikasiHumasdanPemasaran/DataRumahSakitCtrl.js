define(['initialize'], function(initialize) {
	'use strict';
	 initialize.controller('DataRumahSakitCtrl', ['$rootScope', '$scope', 'ModelItem', 'DataPerusahaanBekerjasama' ,'TampilDataPerusahaanBekerjasama', 'ManageSarpras', '$state',
        function($rootScope, $scope, ModelItem,DataPerusahaanBekerjasama,TampilDataPerusahaanBekerjasama, ManageSarpras, $state) {
		$scope.item = {};
		
		
		DataPerusahaanBekerjasama.getOrderList("data-perusahaan-yang-bekerjasama/get-perusahaan-yang-bekerja-sama/", true).then(function(dat){
...
//MasterLinen.getOrderList("service/list-generic/?view=JenisLinen&select=*").then(function(dat){
	...
	//		});
			...
			"width": "100px" 
				...
				"field": "dataPerusahaanYangBekerjaSama.alamatPenagihan",
			"title": "Alamat",
			"width": "100px"
			
            }, {
			"field": "dataPerusahaanYangBekerjaSama.contactPerson",
				"title": "No Telp",
				"width": "100px"			
