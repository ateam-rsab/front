define(['initialize'], function(initialize) {
  'use strict';
  initialize.controller('InformasiJadwalPelayananDokter2Ctrl', ['$rootScope', '$scope', 'ModelItem','$state','DateHelper','ManageLogInfo','$mdDialog','$element',
    function($rootScope, $scope, ModelItem,$state,DateHelper,ManageLogInfo,$mdDialog,$element) {
      $scope.item = {};
      ModelItem.get("AplikasiHumasdanPemasaran/InformasiJadwalPelayananDokter2").then(function(data) {
        $scope.item = data;
        ...
        if($scope.dataSelected)
                {
                    ...
                    {
if ($scope.dataSelected.isCRUD=='U'){
    $scope.dataSelected.isCRUD ="update"
       }
