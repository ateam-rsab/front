...
define(['initialize'], function(initialize) {
    ...
    'use strict';
    initialize.controller('InformasiKamarRawatInapCtrl', ['DateHelper','ManagePasien', '$rootScope', '$scope', 'ModelItem', '$state', 'FindPasien',
        function(dateHelper,managePasien, $rootScope, $scope, ModelItem, $state, findPasien) {
            debugger;
            $scope.title = "Informasi Kamar Rawat Inap";
