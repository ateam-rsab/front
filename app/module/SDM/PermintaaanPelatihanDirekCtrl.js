define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('PermintaaanPelatihanDirekCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManageSdm', '$state','ModelItemAkuntansi','CacheHelper','ManageServicePhp','DateHelper',
		function($rootScope, $scope, ModelItem, ManageSdm, $state, modelItemAkuntansi, cacheHelper, manageServicePhp, dateHelper) {
			...
			LoadCache()
			 ...
			 function LoadCache(){
	            var chacePeriode = cacheHelper.get('PermintaaanPelatihanDirekCtrl');
		    ...
		    function init() {
                ...
                manageServicePhp.getDataTableTransaksi("sdm-pelatihan/get-data-pengajuan-pelatihan-direk?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
                    ...
                    for (var i = 0; i < dat.data.daftar.length; i++) {
                        ...
                        if (dat.data.daftar[i].verifikasidirekturfk != null) {
                ...
                cacheHelper.set('PermintaaanPelatihanDirekCtrl', chacePeriode);                
            }
            ...
            $scope.SimpanVerif = function(){
                ...
                var data = 
                {
                    ...
                    verifikasidirekturfk: $scope.dataSelected.verifikasidirekturfk,           
                ...
                manageServicePhp.verifikasidirekturterkait(objSave).then(function(e) {
                    init();
                    $scope.PopUpVerifikasi.close();                 
                });    
            }
