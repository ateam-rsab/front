define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('MonitoringMasaKredensialCtrl', ['$rootScope', '$scope', 'ModelItem','$state',
		function($rootScope, $scope, ModelItem,$state) {
			...
			{
				"field": "hasilUji",
				"title": "Tanggal Akhir Masa Berlaku SPKK",
				"width": "20%"
			},
			{
				"field": "hasilUji",
				"title": "Jadwal Kredensial/Re-Kredensial",
				"width": "20%"
			},
			{
				"field": "hasilUji",
