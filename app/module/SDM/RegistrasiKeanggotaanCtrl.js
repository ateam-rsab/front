define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('RegistrasiKeanggotaanCtrl', ['$rootScope', '$scope', 'ModelItem','$state','JenisKelamin','TipeKeanggotaan','TipeKoleksi','TampilDataBuku','ManageSdm',
		function($rootScope, $scope, ModelItem,$state,TipeKeanggotaan,TipeKoleksi,TampilDataBuku,JenisKelamin,ManageSdm) {
