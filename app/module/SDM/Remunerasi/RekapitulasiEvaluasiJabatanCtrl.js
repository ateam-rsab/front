define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RekapitulasiEvaluasiJabatanCtrl', ['$q', 'ManagePegawai', 'FindPegawai', 'DateHelper', 'FindSdm', 'ModelItem', 'ManageSdm', 'ManageSdmNew', '$state', '$rootScope', '$scope',
        function ($q, managePegawai, findPegawai, dateHelper, findSdm, modelItem, manageSdm, ManageSdmNew, $state, $rootScope, $scope) {

            $scope.optSourceRekapitulasi = {
                toolbar: [{
                    text: "export",
                    name: "Export detail",
                    ...
                    text: "history",
                    name: "Riwayat",
                    template: '<button ng-click="goToRiwayat()" class="k-button k-button-icontext k-grid-upload">Riwayat Evaluasi Jabatan</button>'
                }],
                filterable: {
                    extra: false,
                    operators: {
            ...
            let init = () => {
                ...
                ManageSdmNew.getListData("sdm/get-all-evaluasi-jabatan").then((res) => {
                    ...
                    $scope.dataSourceRekapitulasi = new kendo.data.DataSource({
                        data: res.data.data,
                        pageSize: 20
                    })
                })
                ...
                tempDataExport.fetch(function () {
                    ...
                    var workbook = new kendo.ooxml.Workbook({
                        sheets: [{
                            ...
                            // Title of the sheet
                            title: "Rekapitulasi Evaluasi Jabatan",
                            // Rows of the sheet
                            rows: [{
                                cells: [{
            ...
            $scope.goToRiwayat = function () {
                $state.go('RiwayatEvaluasiJabatan')
            }
        }
    ])
});