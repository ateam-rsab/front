define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('InputRekomendasiHTACtrl', ['$rootScope', '$scope', 'ModelItem','$state','NamaAsuransi','ManageSdm',
		function($rootScope, $scope, ModelItem,$state,NamaAsuransi,ManageSdm) {
			...
			{
				"field": "satuan",
				"title": "Tanggal Rekomendasi HTA",
				"width": "20%"
			},
			{
				"field": "hasilUji",
				"title": "Rekomendasi HTA",
				"width": "20%"
			}
			];
