define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('MasterJabatanCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'NamaAsuransi', 'ManageSdm', '$timeout',
		function($q, $rootScope, $scope, ModelItem, $state, NamaAsuransi, ManageSdm, $timeout) {
			...
			function init(){
				...
				$q.all([
					ManageSdm.getOrderList("service/list-generic/?view=Jabatan&select=id,namaJabatan,kdJabatan,usiaPensiun,jenisJabatanId,levelJabatan,eselonId&criteria=statusEnabled&values=true", true),
						...
						$scope.daftarJabatan = new kendo.data.DataSource({ 
							...
							schema: {
                                model: {
                                    ...
                                    fields: {
                                        id: {editable: false},
                                        namaJabatan: {editable: true, validation: { 
                                        ...
                                        jenisJabatanId: {editable: true, validation: { 
                                        ...
                                        eselonId: {editable: true, validation: { 
