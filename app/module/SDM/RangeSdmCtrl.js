define(['initialize'], function(initialize) {
	'use strict';
initialize.controller('RangeSdmCtrl', ['$q', '$rootScope', '$scope', 'IPSRSService',
...
$scope.item.kdRange = current.kdRange;
$scope.item.namaRange = current.namaRange;
$scope.item.qRange = current.qRange;
