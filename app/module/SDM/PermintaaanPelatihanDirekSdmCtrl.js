define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('PermintaaanPelatihanDirekSdmCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManageSdm', '$state','ModelItemAkuntansi','CacheHelper','ManageServicePhp','DateHelper',
		function($rootScope, $scope, ModelItem, ManageSdm, $state, modelItemAkuntansi, cacheHelper, manageServicePhp, dateHelper) {
			...
			LoadCache()
			 ...
			 function LoadCache(){
	            var chacePeriode = cacheHelper.get('PermintaaanPelatihanDirekSdmCtrl');
		    ...
		    function init() {
                ...
                manageServicePhp.getDataTableTransaksi("sdm-pelatihan/get-daftar-monitoring-pengajuan-pelatihan-direk?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
                    ...
                    for (var i = 0; i < dat.data.daftar.length; i++) {
                        ...
                        if (dat.data.daftar[i].verifikasidireksdmfk != null) {
                            dat.data.daftar[i].statusverifikasidirek = 'Verifikasi';
                        }else{
                             dat.data.daftar[i].statusverifikasidirek = '-'
                        }
                    }
                ...
                cacheHelper.set('PermintaaanPelatihanDirekSdmCtrl', chacePeriode);                
            }
		    ...
		    $scope.columnGrid = [
                ...
                {
                    field: "statusverifikasidirek",
                    title: "Verifikasi Direktur SDM",
                    width: "120px"
                }                   
            ];
            ...
            $scope.SimpanVerif = function(){
                ...
                if ($scope.dataSelected.verifikasidireksdmfk != undefined || $scope.dataSelected.verifikasidireksdmfk != null) {
                ...
                var data = 
                {
                    ...
                    verifikasidireksdmfk: $scope.dataSelected.verifikasidireksdmfk,           
                ...
                manageServicePhp.verifikasidirektursdmpengajuanpelatihan(objSave).then(function(e) {
                    init();
                    $scope.item={};
                    $scope.PopUpVerifikasi.close();                 
                });    
            ...
            $scope.UnverifikasiPengajuan = function(current){
                ...
                manageServicePhp.unverifikasidirektursdmpengajuanpelatihan(objSave).then(function(e) {
                    init();
                    ClearAll();                   
                });   
            }
