define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('MasterTunjanganLayananPegawaiCtrl', ['$rootScope', '$scope',
        ...
        function($rootScope, $scope, ModelItem, $state,
            ...
            $scope.columnGridMasterTunjanganLayananPeg = { 
                pageable: true,
            ...
            function initial(){ 
                $scope.item = {};
                $scope.vals = false;
                ManageSdm.getOrderList("pegawai-ja/get-all-pegawai-ja", true).then(function(dat) {
                    $scope.gridMasterTunjanganLayananPeg = dat.data;
                }); 
            }
            ...
            $scope.Save = function () { 
                ...
                ManageSdm.saveJenisSantunan(ModelItem.beforePost(data), "pegawai-ja/save-pegawai-ja").then(function(e) {
                    initial();                 
                });
            };
