define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('PermintaaanPelatihanRevCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManageSdm', '$state','ModelItemAkuntansi','CacheHelper','ManageServicePhp','DateHelper',
		function($rootScope, $scope, ModelItem, ManageSdm, $state, modelItemAkuntansi, cacheHelper, manageServicePhp, dateHelper) {
			...
			LoadCache()
			 ...
			 function LoadCache(){
	            var chacePeriode = cacheHelper.get('PermintaaanPelatihanRevCtrl');
		    ...
		    function init() {
                ...
                manageServicePhp.getDataTableTransaksi("sdm-pelatihan/get-data-pengajuan-pelatihan?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
