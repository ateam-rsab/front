define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DetailPermohonanKredensialCtrl', ['$rootScope', '$scope', 'ModelItem','TipeKeanggotaan','TipeKoleksi','PeriodePinjaman','$state','ManageSdm',
		function($rootScope, $scope, ModelItem,TipeKeanggotaan,TipeKoleksi,PeriodePinjaman,$state,ManageSdm) {
			...
			$scope.daftarBahanLinen = new kendo.data.DataSource({
				data:[
					...
					{ 
						"no":"8",
						"unsur":"Surat Keteranggan Berbadan sehat/sakit"
					}
