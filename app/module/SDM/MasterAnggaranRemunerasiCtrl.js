define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MasterAnggaranRemunerasiCtrl', ['$q', '$rootScope', '$scope', 'ModelItem', '$state', 'NamaAsuransi', 'ManageSdm', 'ManageSdmNew', '$timeout',
        function ($q, $rootScope, $scope, ModelItem, $state, NamaAsuransi, ManageSdm, ManageSdmNew, $timeout) {
            ...
            $scope.simpanEdit = () => {
                // http://192.168.12.3:8080/jasamedika-sdm/sdm/save-plafon-remunerasi
                let data = {
