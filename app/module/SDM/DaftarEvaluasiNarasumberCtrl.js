define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarEvaluasiNarasumberCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManageSdm', '$state','ModelItemAkuntansi','CacheHelper','ManageServicePhp','DateHelper',
		function($rootScope, $scope, ModelItem, ManageSdm, $state, modelItemAkuntansi, cacheHelper, manageServicePhp, dateHelper) {
		    ...
		    function init() {
                ...
                manageServicePhp.getDataTableTransaksi("sdm-pelatihan-narasumber/get-daftar-evaluasi-narasumber?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
            ...
            $scope.Hapus = function(current){
                ...
                manageServicePhp.hapusevaluasinarasumber(objSave).then(function(e) {
                	init();
                    ClearAll();                   
            	});
            }
