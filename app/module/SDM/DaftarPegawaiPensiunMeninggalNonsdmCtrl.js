define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPegawaiPensiunMeninggalNonsdmCtrl', ['$q', '$rootScope', '$scope', 'ModelItem','$state', 'FindSdm', '$timeout', 'ManageSdm', 'ManageSdmNew', 'DateHelper',
		function($q, $rootScope, $scope, ModelItem, $state, FindSdm, $timeout, ManageSdm, ManageSdmNew, dateHelper) {
            //$state.go('UnderMaintenance',  { namaForm: 'DaftarPegawaiPensiunMeninggalNonsdm' });
            $scope.title = "Data Pegawai Pensiun/Meninggal Mitra & PPDS" ;
			$scope.item = {};
            ...
            $q.all([
                ...
                ManageSdmNew.getListData("pegawai/get-pegawai-meninggal-pindah-pensiun-nonsdm/")
            ...
            // FindSdm.getListData("pegawai/get-pegawai-meninggal-pindah-pensiun-nonsdm/").then(function(res) {
