define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPenelitianEksternalRevCtrl', ['$rootScope', '$scope', 'ModelItem','$state','ManageSarpras','ModelItemAkuntansi','ManageServicePhp','DateHelper','CacheHelper',
		function($rootScope, $scope, ModelItem,$state,ManageSarpras,modelItemAkuntansi,manageServicePhp,dateHelper,cacheHelper) {
			...
			function GetData(){
                ...
                manageServicePhp.getDataTableTransaksi("sdm-penelitian/get-daftar-penelitian-eksternal?"
                    +"tglAwal="+tglAwal+
                    "&tglAkhir="+tglAkhir
                    ...
                    cacheHelper.set('DaftarPenelitianEksternalRevCtrl', chacePeriode);
                });
			}
			...
			$scope.Ubah = function(current){
                ...
                cacheHelper.set('PenelitianEksternalRevCtrl', chacePeriode);
                $state.go('PenelitianEksternalRev', {
			...
			$scope.Hapus = function(current){
                ...
                manageServicePhp.hapuskegiatanpenelitianeksternal(objSave).then(function (e) {
                    GetData()
                })
            }
