define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('AuditKewenanganKlinisCtrl', ['$rootScope', '$scope', 'ModelItem','TipeKeanggotaan','TipeKoleksi','PeriodePinjaman','$state','ManageSdm',
