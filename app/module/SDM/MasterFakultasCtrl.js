define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('MasterFakultasCtrl', ['$rootScope', '$scope', 'ModelItem', 'ManagePhp',
		function($rootScope, $scope, ModelItem, managePhp) {
			$scope.item = {};
			var init = function () {
				managePhp.getMaster("master-sdm/get-daftar-fakultas").then(function(dat){
			...
			$scope.klik = function(grid){
                ...
                $scope.item.kategoriPendidikan = grid.fakultas;
			...
			$scope.mainGridOptions = { 
				...
				{ field:"fakultas",title:"Fakultas","width": "60px" },
			...
			$scope.simpan = function () {
				...
				var data = {
					"id":IDID,
					"fakultas":$scope.item.kategoriPendidikan,
					"statusenabled":enaena
				}
				managePhp.postMaster(data, "master-sdm/save-master-fakultas").then(function(e) {
					$scope.item = {};
					init();
				});
			}
