define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPaketSeminarCtrl', ['$rootScope', '$scope', 'ModelItem','$state','NamaAsuransi','ManageSdm',
		function($rootScope, $scope, ModelItem,$state,NamaAsuransi,ManageSdm) {
			...
			$scope.Save = function() {
             ...
             ManageSdm.saveDaftarPaketSeminar(ModelItem.beforePost($scope.item)).then(function (e) {
                  $scope.item= {};
                   init();  
