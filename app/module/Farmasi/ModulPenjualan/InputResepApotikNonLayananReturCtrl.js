define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('InputResepApotikNonLayananReturCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper',
...
// 30  0   t       jasa pelayanan Repacking obat injeksi
        ...
        // ];
            ...
            $scope.simpan = function(){
                ...
                //
                manageLogistikPhp.postReturObatBebas(objSave).then(function(e) {
