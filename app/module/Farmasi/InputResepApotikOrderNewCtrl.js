define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('InputResepApotikOrderNewCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper',
        ...
        function init() {
            ...
            manageLogistikPhp.getDataTableTransaksi('logistik/get-daftar-detail-order?norec_apd='+norecAPD).then(function(e) {
