define(['initialize'], function (initialize) {
	'use strict';
	initialize.controller('DaftarAdvokasiHukumTujuanCtrl', ['$rootScope', '$scope', 'ModelItem', 
        ...
        function ($rootScope, $scope, ModelItem, DateHelper, $document, $state, ManageSarpras) {
            ...
            function getGrid() {  
                ...
                var url = "advokasi-hukum-medicolegal/get-list-evaluasi-by-ruangan-tujuan?tglAwal=" + awal + "&tglAkhir=" + akhir +"&ruanganId=" +ModelItem.getPegawai().ruangan.id ;
