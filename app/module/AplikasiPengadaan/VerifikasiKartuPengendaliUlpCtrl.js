define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('VerifikasiKartuPengendaliUlpCtrl', ['$rootScope', '$scope', '$state', 'DateHelper', 'ModelItem', 'dataRupService', 'ManageSarpras',
      ...
      //           },
			...
			$scope.save = function(){
				...
				if(isValid.status){
					...
					ManageSarpras.saveDataSarPras($scope.item, "kartu-pengendali/verifikasi-kartu-pengendali-by-ulp/").then(function(e){
