define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('VerifikasiKartuPengendaliPPCtrl', ['$rootScope', '$scope', '$state', 'DateHelper', 'ModelItem', 'dataRupService', 'ManageSarpras',
		 ...
		 //    });
			...
			$scope.save = function(){
				...
				if(isValid.status){
					...
					$scope.dats.kartuPengendali = kartuPengendaliDetail;
					$scope.dats.tanggal = DateHelper.getPeriodeFormatted(new Date($scope.item.tanggal));

					ManageSarpras.saveDataSarPras($scope.dats, "kartu-pengendali/verifikasi-kartu-pengendali-by-pp").then(function(e){
