define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('VerifikasiKartuPengendaliDirekturCtrl', ['$rootScope', '$scope', '$state', 'DateHelper', 'ModelItem', 'dataRupService', 'ManageSarpras',
		 ...
		 //    });
			...
			$scope.save = function(){
                ...
                if(isValid.status){
					...
					ManageSarpras.saveDataSarPras($scope.item, "kartu-pengendali/verifikasi-kartu-pengendali-by-direktur/").then(function(e){
