...
define(['initialize'], function(initialize) {
    ...
    'use strict';
    initialize.controller('DaftarRencanaPindahPasienCtrl', ['$state', 'FindPasien', '$rootScope', '$scope', 'ModelItem', 'DateHelper', 'CacheHelper', 'ManagePasien', 'ManageServicePhp',
        function($state, findPasien, $rootScope, $scope, ModelItem, dateHelper, cacheHelper,ManagePasien, manageServicePhp) {
            ...
            function init() {
                ...
                manageServicePhp.getDataTableTransaksi("registrasi/get-daftar-pasien-rencana-pindah?"+
                    "tglAwal=" + tglAwal + 
                    "&tglAkhir=" + tglAkhir +
