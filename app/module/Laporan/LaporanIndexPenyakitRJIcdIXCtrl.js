define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanIndexPenyakitRJIcdIXCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi','ModelItem', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening','ManageServicePhp',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi,ModelItem, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening, manageServicePhp) {
            ...
            function LoadData() {
               ...
               var idJenisDiagnosa = "";
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-index-rj-icd-ix?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + idDiagnosaAwal
                    + idDiagnosaAkhir
