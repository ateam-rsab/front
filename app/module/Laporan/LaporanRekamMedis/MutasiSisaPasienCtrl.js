define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('MutasiSisaPasienCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-data-lap-pasien-sisa?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
                    ...
                    // + tempKelPasienId
                       ...
                       $scope.isRouteLoading = false;
                    // var doubleTotalPasien = 0;
                   
                    // for (var i = 0; i < data.data.length; i++) {
                    //     doubleTotalPasien = doubleTotalPasien + parseFloat(data.data[i].length)
                      
                    // }
              
                    $scope.item.totalpasien =  data.data.length;
