define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanIndexPenyakitRICtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi','ModelItem', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi,ModelItem, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-index-ri?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + idDiagnosaAwal
                    + idDiagnosaAkhir
            ...
            $("#kGrid").kendoGrid({
                toolbar: ["excel"],
                    ...
                    excel: {
                        fileName: "IndexPenyakitRawatInap.xlsx",
                        allPages: true,
                ...
                excelExport: function(e) {
                    ...
                    rows.unshift({
                        cells: [ { value: "Index Penyakit RI", background: "#fffff" } ]
                    });
                },
                columns: [
                {
