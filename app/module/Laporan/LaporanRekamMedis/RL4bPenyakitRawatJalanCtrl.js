define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RL4bPenyakitRawatJalanCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi','ModelItem', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi,ModelItem, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-laporan-rl4b?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
