define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('SurveilansKasusPtmRICtrl', ['CacheHelper','$q', '$rootScope', '$scope','ModelItemAkuntansi','DateHelper','$http','$state','ReportPelayanan','ManageSdm','ManageLogistikPhp', 'FindPasien', 'ManageTataRekening',
    function(cacheHelper,$q, $rootScope, $scope,modelItemAkuntansi,DateHelper,$http,$state,ReportPelayanan,ManageSdm,manageLogistikPhp,findPasien, manageTataRekening) {
          ...
          function LoadData() {  
              ...
              cacheHelper.set('SurveilansKasusPtmRICtrl', chacePeriode);
  
              modelItemAkuntansi.getDataTableTransaksi("laporan/get-data-surveilans-ranap?"
                  + "tglAwal=" + tglAwal
                  + "&tglAkhir=" + tglAkhir
                //   + tempRuanganId
                //   + tempDepartemen
