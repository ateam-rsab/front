define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanTindakanPerKelompokKerjaCtrl', ['$q', '$scope', 'CacheHelper', 'DateHelper', 'ManagePhp', 'ModelItemAkuntansi', '$mdDialog',
        function ($q, $scope, cacheHelper, dateHelper, ManagePhp, modelItemAkuntansi, $mdDialog) {
            ...
            $scope.columnGrid = {
                ...
                excelExport: function (e) {
                    ...
                    var myHeaders = [
                        ...
                        {
                            value: "LAPORAN TINDAKAN PER-KELOMPOK KERJA " +dateHelper.formatDate($scope.item.periodeAwal, 'DD-MM-YY') +' sampai ' +
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "width": "90px",
                        "template": "<span class='style-left'>#: kelompokkerjahead #</span>"
                    },
                    {
                        "field": "kelompokkerja",
                        "title": "Kelompok Kerja",
                        "width": "90px",
                        "template": "<span class='style-left'>#: kelompokkerja #</span>"
                    },
                    // {
                    //     "field": "tglpelayanan",
                    //     "title": "Tanggal",
            ...
            function loadData() {
                ...
                ManagePhp.getData("laporan/get-lap-ksm-kk?" +
                    "tglAwal=" + tglAwal +
                    "&tglAkhir=" + tglAkhir +
                    layanan + kondisi + kkHead + Kkerja +
                    '&jmlRows=' + jmlRows +
