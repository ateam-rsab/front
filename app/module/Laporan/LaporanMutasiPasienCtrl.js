define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanMutasiPasienCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            $scope.changeTabItem = function () {
                if ($scope.item.jenisMutasi.id == 1)
                    $scope.coba= true;    
            }

            $scope.CariPasienMasuk = function () {
               LoadPasienMasuk()
            }
            function LoadPasienMasuk() {
            ...
            $scope.CariPasienKeluar = function () {
                LoadPasienKeluar()
             }
             function LoadPasienKeluar() {
