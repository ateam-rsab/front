define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanPerincianImunisasiCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('LaporanPerincianImunisasiCtrl', chacePeriode);
                $scope.isLoadingData = true;
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-perincian-imunisasi?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                ...
                excel: {
                    fileName: "PerincianImunisasiAlamanda.xlsx",
                    allPages: true,
                ...
                excelExport: function(e) {
                    ...
                    rows.unshift({
                        cells: [ { value: "Perincian Imunisasi (Klinik Bayi Sehat & Alamanda)", background: "#fffff" } ]
                    });
                  },
                columns: [
                    // {
                    ...
                    },
                    {
                        ...
                        title: "Jenis Vaksin",
                        width: "130px",
                        template: "<span class='style-center'>#: jenisvaksin #</span>",
                        headerAttributes: { style: "text-align : center" },
                        // groupHeaderTemplate: "Klinik #= value # (Jumlah: #= count#)"
                    },
                    {
                        title: "Klinik",
                        headerAttributes: { style: "text-align : center" },
