define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('JenisKunjunganCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-radiologi-jenis-kunjungan?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                ...
                excel: {
                    fileName: "JenisKunjunganRadiologi.xlsx",
                    allPages: true,
                ...
                excelExport: function (e) {
                    ...
                    rows.unshift({
                        cells: [{ value: "Jenis Kunjungan Radioologi", background: "#fffff" }]
                    });
                },
                columns: [
                    // {
