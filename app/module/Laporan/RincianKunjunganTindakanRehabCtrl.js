define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RincianKunjunganTindakanRehabCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                cacheHelper.set('RincianKunjunganTindakanRehabCtrl', chacePeriode);
                $scope.isLoadingData = true;
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-rincian-kunjungan-rehab?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                ...
                excelExport: function(e) {
                    ...
                    rows.unshift({
                        cells: [ { value: "Rincian Kunjungan & Tindakan Poliklinik Rehabilitasi Medik", background: "#fffff" } ]
                    });
                  },
                columns: [
                    // {
