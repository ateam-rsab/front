define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('LaporanIndexPenyakitRIIcdIXCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi','ModelItem', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening','ManageServicePhp',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi,ModelItem, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening, manageServicePhp) {
            //Inisial Variable 
            ...
            function LoadData() {
                ...
                if ($scope.item.diagnosa1 != undefined) {
                    idDiagnosaAwal = "&idDiagnosaAwal=" + $scope.item.diagnosa1.kdDiagnosaTindakan;
                }
                  var idDiagnosaAkhir = "";
                if ($scope.item.diagnosa2 != undefined) {
                    idDiagnosaAkhir = "&idDiagnosaAkhir=" + $scope.item.diagnosa2.kdDiagnosaTindakan;
                }
               ...
               var idJenisDiagnosa = "";
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-index-ri-icd-ix?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    + idDiagnosaAwal
                    + idDiagnosaAkhir
