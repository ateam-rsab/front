define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RincianKunjunganPenunjangRadiologiCtrl', ['CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi', 'DateHelper', '$http', '$state', 'ReportPelayanan', 'ManageSdm', 'ManageTataRekening',
        function (cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi, DateHelper, $http, $state, ReportPelayanan, ManageSdm, manageTataRekening) {
            ...
            function LoadData() {
                ...
                modelItemAkuntansi.getDataTableTransaksi("laporan/get-kunjungan-radiologi?"
                    + "tglAwal=" + tglAwal
                    + "&tglAkhir=" + tglAkhir
                    // + tempDepartemenId
                    + tempRuanganId
            ...
            $("#kGrid").kendoGrid({
                ...
                excel: {
                    fileName: "RincianKunjunganRadiologi.xlsx",
                    allPages: true,
