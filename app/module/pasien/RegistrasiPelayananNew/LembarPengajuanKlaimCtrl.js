define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('LembarPengajuanKlaimCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'ManagePasien', 'FindPasien','ManageServicePhp','ModelItemAkuntansi',
        ...
        $scope.Tambah2=function(){
            ...
            dataDiagnosaTin={
                ...
                function getComboBridging(){
                  ...
                  // });
                  //  modelItemAkuntansi.getDataDummyPHP("bpjs/get-diagnosa-tindakan-saeutik", true, true, 10).then(function(data) {
