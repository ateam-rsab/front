define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('DeleteLembarPengajuanKlaimCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'ManagePasien', 'FindPasien','ManageServicePhp',
        function($rootScope, $scope, ModelItem, $state, DateHelper, managePasien, findPasien ,manageServicePhp) {
            ...
            $scope.findDataBySep = function(data){
                $scope.isRouteLoading = true;
                manageServicePhp.deleteLPK(data).then(function(e) {
