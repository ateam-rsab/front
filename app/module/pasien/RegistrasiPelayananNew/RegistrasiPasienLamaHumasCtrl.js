define(['initialize'], function (initialize) {
    'use strict';
    initialize.controller('RegistrasiPasienLamaHumasCtrl', ['ManageServicePhp','CacheHelper', '$q', '$rootScope', '$scope', 'ModelItemAkuntansi','ModelItem', 'DateHelper', '$http', '$state', 'ReportPelayanan',
        function (manageServicePhp, cacheHelper, $q, $rootScope, $scope, modelItemAkuntansi,ModelItem, DateHelper, $http, $state, ReportPelayanan,) {
            ...
            loadFirst()
            function loadFirst(){
                var chacePeriode = cacheHelper.get('RegistrasiPasienLamaHumasCtrl');
