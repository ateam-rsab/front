define(['initialize'], function(initialize) {
	'use strict';
	initialize.controller('DaftarPasienByDiagnosaCtrl', ['$mdDialog', '$timeout', '$state', '$q', '$rootScope', '$scope', 'CacheHelper','DateHelper','ManageTataRekening', 'ModelItem','CetakHelper','ManagePasien','ModelItemAkuntansi',  
		function($mdDialog, $timeout, $state, $q, $rootScope, $scope, cacheHelper,dateHelper,manageTataRekening, ModelItem, cetakHelper, managePasien, modelItemAkuntansi) {
			...
			function loadCombo(){
                ...
                modelItemAkuntansi.getDataDummyPHP("pasien/get-combo-icd10", true, true, 10).then(function(data) {
    ...
    //             }
				...
				$q.all([
					manageTataRekening.getDataTableTransaksi("dokter/get-daftarpasien-by-diagnosa?"+
						"tglAwal="+tglAwal+
						"&tglAkhir="+tglAkhir+
