define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('insertSepCtrl', ['$rootScope', '$scope', 'ModelItem', '$state', 'DateHelper', 'ManagePasien', 'FindPasien',
        function($rootScope, $scope, ModelItem, $state, DateHelper, managePasien, findPasien) {
            ...
            $scope.generateSep = function(data){
                ...
                if(isValid.status){
                    ...
                    managePasien.generateSep(dataGenerate).then(function(e) {
