define(['initialize'], function(initialize) {
    ...
    initialize.controller('RegistrasiPelayananGawatDaruratCtrl', ['ManagePasien', '$scope', 'ModelItem', '$state', '$rootScope', 'FindPasien', '$interval', 'socket', 'ManagePhp',
        ...
        //Buatan urang
        ManagePhp.getData("generic/get-jenis-kelamin/").then(function(dat){
        ...
        //Buatan urang
        ManagePhp.getData("generic/get-hubungan-keluarga/").then(function(dat){
                
            $scope.listHubunganKeluarga=dat.data.hubunganKeluarga; 

        }); 

        ManagePhp.getData("generic/get-status-bawa/").then(function(dat){
