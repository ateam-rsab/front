define(['initialize'], function(initialize) {
    'use strict';
    initialize.controller('TransaksiPelayananRadiologiCtrl', ['$q', '$rootScope', '$scope', 'ManageLogistikPhp','$state','CacheHelper','ManagePasien',
        ...
        function init() {
            ...
            manageLogistikPhp.getDataTableTransaksi("pelayanan/get-list-pelayanan?departemenfk=27&nocm="+$scope.item.noMr, true).then(function(dat){
